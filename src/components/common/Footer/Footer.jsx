    ...
    <>
      ...
      <div className="container">
        ...
        <div className="footer-middle">
          <Row gutter={[24, 24]}>
            <Col xs={24} md={10}>
              <div className='footer-middle-logo'> VIỆT HOÀNG </div>
              <br />
              <p className='logo-desc'>VIETHOANG.VN chuyên phân phối sỉ và lẻ các loại Vang, Bia từ các nước trên thế giới. Với sứ mệnh lan tỏa văn hóa ẩm thực rượu vang tới nhiều người Việt hơn nữa. VIETHOANG.VN luôn nỗ lực tìm kiếm và phân phối các dòng Vang cao cấp với giá cả tốt nhất đến người tiêu dùng Việt.</p>
            </Col>
            <Col xs={24} md={14}>
              <Row>
          ...
          <div className="container">
            <Row gutter={16} className='footer-bottom'>
      ...
      <div className="footer-below-block">
        <h1>Copyright © 2025 <p className='footer-below-block-decoration'>VIETHOANG.VN. Powered by VIETHOANG.VN</p></h1>
      </div>
    </>
